    ...
    <>
      ...
      <h1 className='container datavalue'>Slot Booked</h1>
      {
        bookedslots.length == 0 ? <div>
          < h5 className='container'>No slot Booked till now.</ h5>
        </div>  : 
          bookedslots.map((bs) => {
            return <>
              <div className= 'card-body bookedslots' key={bs._id}>
                <  h5 className="card-title">Center Name :  {bs.name}</  h5>
                <hr />
                <  h5 className="card-text">Center Place : {bs.place}</  h5>
                <hr />
                <  h5 className="card-text">Slot date : {bs.slotdate}</  h5>
                <hr />
        ...
        centers.map((center) => {
          return <>
            <div className="card-body centers" key={center._id}>
              <  h5 className="card-title">Center Name :  {center.name}</  h5>
              <hr />
              <  h5 className="card-text">Center Place : {center.place}</  h5>
              <hr />
              <  h5 className="card-text">Dosage Availabe : {center.dosage}</  h5>
